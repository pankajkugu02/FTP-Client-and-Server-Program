...
class Server
{
	...
	public static void main(String a[]) throws Exception
	{
		...
		int length=0;
        Inet6Address IPAddress= (Inet6Address)packin.getAddress();
    ...
    public static void sendDataToClient(byte[] sendData, Inet6Address IPAddress, int port, int timeout) throws IOException
    {
        ...
        do
        {
            ...
            try
            {
                serversocket.accept(receivePacket);
